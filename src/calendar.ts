...
import { getHolidaysForDate, formatDate, type Holiday } from './holidays.js';

export class Calendar {
    private currentYear: number;
    private currentMonth: number;
    private selectedDate: Date | null = null;
    private holidayFilter: string = 'all';
    ...
    private renderMonthSelector(): void {
    ...
    private createDateCell(date: Date, isOtherMonth: boolean): HTMLElement {
    ...
    private filterHolidays(holidays: Holiday[]): Holiday[] {
    ...
    private selectDate(date: Date, cellElement: HTMLElement): void {
    ...
    private showDateInfo(date: Date): void {
      ...
      <span class="info-value">${lunarInfo.yearInGanZhi}年 ${lunarInfo.monthInChinese}${lunarInfo.dayInChinese}</span>
        ...
        <span class="info-value">`;
            ...
            holidays.forEach((holiday, index) => {
                ...
                if (index < holidays.length - 1) html += '<br>';
            });
    ...
    public setHolidayFilter(filter: string): void {
